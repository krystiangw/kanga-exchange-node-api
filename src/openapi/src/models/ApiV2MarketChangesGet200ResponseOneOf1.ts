 ...
 */
export function instanceOfApiV2MarketChangesGet200ResponseOneOf1(value: object): boolean {
    let isInstance = true;
...
export function ApiV2MarketChangesGet200ResponseOneOf1FromJSON(json: any): ApiV2MarketChangesGet200ResponseOneOf1 {
    return ApiV2MarketChangesGet200ResponseOneOf1FromJSONTyped(json, false);
}

export function ApiV2MarketChangesGet200ResponseOneOf1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV2MarketChangesGet200ResponseOneOf1 {
...
export function ApiV2MarketChangesGet200ResponseOneOf1ToJSON(value?: ApiV2MarketChangesGet200ResponseOneOf1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
