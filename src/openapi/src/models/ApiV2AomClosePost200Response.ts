...
import {
    ApiV2AomClosePost200ResponseOneOf,
    instanceOfApiV2AomClosePost200ResponseOneOf,
    ApiV2AomClosePost200ResponseOneOfFromJSON,
    ApiV2AomClosePost200ResponseOneOfFromJSONTyped,
    ApiV2AomClosePost200ResponseOneOfToJSON,
} from './ApiV2AomClosePost200ResponseOneOf';
import {
    ApiV2AomClosePost200ResponseOneOf1,
    instanceOfApiV2AomClosePost200ResponseOneOf1,
    ApiV2AomClosePost200ResponseOneOf1FromJSON,
    ApiV2AomClosePost200ResponseOneOf1FromJSONTyped,
    ApiV2AomClosePost200ResponseOneOf1ToJSON,
} from './ApiV2AomClosePost200ResponseOneOf1';
import {
    ApiV2AomClosePost200ResponseOneOf2,
    instanceOfApiV2AomClosePost200ResponseOneOf2,
    ApiV2AomClosePost200ResponseOneOf2FromJSON,
    ApiV2AomClosePost200ResponseOneOf2FromJSONTyped,
    ApiV2AomClosePost200ResponseOneOf2ToJSON,
} from './ApiV2AomClosePost200ResponseOneOf2';
import {
...
export function ApiV2AomClosePost200ResponseFromJSON(json: any): ApiV2AomClosePost200Response {
    return ApiV2AomClosePost200ResponseFromJSONTyped(json, false);
}

export function ApiV2AomClosePost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV2AomClosePost200Response {
...
export function ApiV2AomClosePost200ResponseToJSON(value?: ApiV2AomClosePost200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfApiV2AomClosePost200ResponseOneOf(value)) {
        return ApiV2AomClosePost200ResponseOneOfToJSON(value as ApiV2AomClosePost200ResponseOneOf);
    }
    if (instanceOfApiV2AomClosePost200ResponseOneOf1(value)) {
        return ApiV2AomClosePost200ResponseOneOf1ToJSON(value as ApiV2AomClosePost200ResponseOneOf1);
    }
    if (instanceOfApiV2AomClosePost200ResponseOneOf2(value)) {
        return ApiV2AomClosePost200ResponseOneOf2ToJSON(value as ApiV2AomClosePost200ResponseOneOf2);
    }
