...
import {
    ApiV2LabelListPost200ResponseOneOf,
    instanceOfApiV2LabelListPost200ResponseOneOf,
    ApiV2LabelListPost200ResponseOneOfFromJSON,
    ApiV2LabelListPost200ResponseOneOfFromJSONTyped,
    ApiV2LabelListPost200ResponseOneOfToJSON,
} from './ApiV2LabelListPost200ResponseOneOf';
import {
...
/**
 * @type ApiV2LabelListPost200Response
 * 
 * @export
 */
export type ApiV2LabelListPost200Response = ApiV2LabelListPost200ResponseOneOf | ApiV2PayPaymentGetPost200ResponseOneOf1 | ApiV2PayPaymentGetPost200ResponseOneOf2 | ApiV2PayPaymentGetPost200ResponseOneOf3;

export function ApiV2LabelListPost200ResponseFromJSON(json: any): ApiV2LabelListPost200Response {
    return ApiV2LabelListPost200ResponseFromJSONTyped(json, false);
}

export function ApiV2LabelListPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV2LabelListPost200Response {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return { ...ApiV2LabelListPost200ResponseOneOfFromJSONTyped(json, true), ...ApiV2PayPaymentGetPost200ResponseOneOf1FromJSONTyped(json, true), ...ApiV2PayPaymentGetPost200ResponseOneOf2FromJSONTyped(json, true), ...ApiV2PayPaymentGetPost200ResponseOneOf3FromJSONTyped(json, true) };
}

export function ApiV2LabelListPost200ResponseToJSON(value?: ApiV2LabelListPost200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfApiV2LabelListPost200ResponseOneOf(value)) {
        return ApiV2LabelListPost200ResponseOneOfToJSON(value as ApiV2LabelListPost200ResponseOneOf);
    }
