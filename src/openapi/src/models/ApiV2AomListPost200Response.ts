...
import {
    ApiV2AomListPost200ResponseOneOf,
    instanceOfApiV2AomListPost200ResponseOneOf,
    ApiV2AomListPost200ResponseOneOfFromJSON,
    ApiV2AomListPost200ResponseOneOfFromJSONTyped,
    ApiV2AomListPost200ResponseOneOfToJSON,
} from './ApiV2AomListPost200ResponseOneOf';
import {
...
export function ApiV2AomListPost200ResponseFromJSON(json: any): ApiV2AomListPost200Response {
    return ApiV2AomListPost200ResponseFromJSONTyped(json, false);
}

export function ApiV2AomListPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV2AomListPost200Response {
...
export function ApiV2AomListPost200ResponseToJSON(value?: ApiV2AomListPost200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfApiV2AomListPost200ResponseOneOf(value)) {
        return ApiV2AomListPost200ResponseOneOfToJSON(value as ApiV2AomListPost200ResponseOneOf);
    }
