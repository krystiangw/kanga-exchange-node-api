 ...
 * @export
 */
export const ApiV2DistributionCreatePost200ResponseOneOf2ResultEnum = {
    Fail: 'fail'
} as const;
 ...
 * @export
 */
export const ApiV2DistributionCreatePost200ResponseOneOf2CodeEnum = {
    NUMBER_9002: 9002
} as const;
 ...
 */
export function instanceOfApiV2DistributionCreatePost200ResponseOneOf2(value: object): boolean {
    let isInstance = true;
...
export function ApiV2DistributionCreatePost200ResponseOneOf2FromJSON(json: any): ApiV2DistributionCreatePost200ResponseOneOf2 {
    return ApiV2DistributionCreatePost200ResponseOneOf2FromJSONTyped(json, false);
}

export function ApiV2DistributionCreatePost200ResponseOneOf2FromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV2DistributionCreatePost200ResponseOneOf2 {
...
export function ApiV2DistributionCreatePost200ResponseOneOf2ToJSON(value?: ApiV2DistributionCreatePost200ResponseOneOf2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
