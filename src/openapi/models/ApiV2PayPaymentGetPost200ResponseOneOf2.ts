 ...
 * @export
 */
export const ApiV2PayPaymentGetPost200ResponseOneOf2ResultEnum = {
    Fail: 'fail'
} as const;
 ...
 * @export
 */
export const ApiV2PayPaymentGetPost200ResponseOneOf2CodeEnum = {
    NUMBER_403: 403
} as const;
 ...
 */
export function instanceOfApiV2PayPaymentGetPost200ResponseOneOf2(value: object): boolean {
    let isInstance = true;
...
export function ApiV2PayPaymentGetPost200ResponseOneOf2FromJSON(json: any): ApiV2PayPaymentGetPost200ResponseOneOf2 {
    return ApiV2PayPaymentGetPost200ResponseOneOf2FromJSONTyped(json, false);
}

export function ApiV2PayPaymentGetPost200ResponseOneOf2FromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV2PayPaymentGetPost200ResponseOneOf2 {
...
export function ApiV2PayPaymentGetPost200ResponseOneOf2ToJSON(value?: ApiV2PayPaymentGetPost200ResponseOneOf2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
