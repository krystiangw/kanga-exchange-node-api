...
export function ApiV2AomStopPost200ResponseFromJSON(json: any): ApiV2AomStopPost200Response {
    return ApiV2AomStopPost200ResponseFromJSONTyped(json, false);
}

export function ApiV2AomStopPost200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV2AomStopPost200Response {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return { ...ApiV2AomGetPost200ResponseOneOf1FromJSONTyped(json, true), ...ApiV2AomStartPost200ResponseOneOfFromJSONTyped(json, true), ...ApiV2PayPaymentGetPost200ResponseOneOf1FromJSONTyped(json, true), ...ApiV2PayPaymentGetPost200ResponseOneOf2FromJSONTyped(json, true), ...ApiV2PayPaymentGetPost200ResponseOneOf3FromJSONTyped(json, true) };
}

export function ApiV2AomStopPost200ResponseToJSON(value?: ApiV2AomStopPost200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
