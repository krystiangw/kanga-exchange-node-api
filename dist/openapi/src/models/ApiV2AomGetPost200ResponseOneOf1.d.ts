 ...
 * @export
 */
export declare const ApiV2AomGetPost200ResponseOneOf1ResultEnum: {
    readonly Fail: "fail";
};
 ...
 * @export
 */
export declare const ApiV2AomGetPost200ResponseOneOf1CodeEnum: {
 ...
 */
export declare function instanceOfApiV2AomGetPost200ResponseOneOf1(value: object): boolean;
export declare function ApiV2AomGetPost200ResponseOneOf1FromJSON(json: any): ApiV2AomGetPost200ResponseOneOf1;
export declare function ApiV2AomGetPost200ResponseOneOf1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV2AomGetPost200ResponseOneOf1;
export declare function ApiV2AomGetPost200ResponseOneOf1ToJSON(value?: ApiV2AomGetPost200ResponseOneOf1 | null): any;
//# sourceMappingURL=ApiV2AomGetPost200ResponseOneOf1.d.ts.map