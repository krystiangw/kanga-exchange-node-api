 ...
 */
import { instanceOfApiV2MarketOrderListPost200ResponseOneOf, ApiV2MarketOrderListPost200ResponseOneOfFromJSONTyped, ApiV2MarketOrderListPost200ResponseOneOfToJSON, } from './ApiV2MarketOrderListPost200ResponseOneOf';
...
export function ApiV2MarketOrderListPost200ResponseFromJSON(json) {
    return ApiV2MarketOrderListPost200ResponseFromJSONTyped(json, false);
}
export function ApiV2MarketOrderListPost200ResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ApiV2MarketOrderListPost200ResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfApiV2MarketOrderListPost200ResponseOneOf(value)) {
        return ApiV2MarketOrderListPost200ResponseOneOfToJSON(value);
    }
