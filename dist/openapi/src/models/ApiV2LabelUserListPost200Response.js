 ...
 */
import { instanceOfApiV2LabelUserListPost200ResponseOneOf, ApiV2LabelUserListPost200ResponseOneOfFromJSONTyped, ApiV2LabelUserListPost200ResponseOneOfToJSON, } from './ApiV2LabelUserListPost200ResponseOneOf';
import { instanceOfApiV2LabelUserListPost200ResponseOneOf1, ApiV2LabelUserListPost200ResponseOneOf1FromJSONTyped, ApiV2LabelUserListPost200ResponseOneOf1ToJSON, } from './ApiV2LabelUserListPost200ResponseOneOf1';
...
export function ApiV2LabelUserListPost200ResponseFromJSON(json) {
    return ApiV2LabelUserListPost200ResponseFromJSONTyped(json, false);
}
export function ApiV2LabelUserListPost200ResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ApiV2LabelUserListPost200ResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfApiV2LabelUserListPost200ResponseOneOf(value)) {
        return ApiV2LabelUserListPost200ResponseOneOfToJSON(value);
    }
    if (instanceOfApiV2LabelUserListPost200ResponseOneOf1(value)) {
        return ApiV2LabelUserListPost200ResponseOneOf1ToJSON(value);
    }
