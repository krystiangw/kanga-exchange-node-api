 ...
 */
import { instanceOfApiV2MarketOrderBookPost200ResponseOneOf, ApiV2MarketOrderBookPost200ResponseOneOfFromJSONTyped, ApiV2MarketOrderBookPost200ResponseOneOfToJSON, } from './ApiV2MarketOrderBookPost200ResponseOneOf';
...
export function ApiV2MarketOrderBookPost200ResponseFromJSON(json) {
    return ApiV2MarketOrderBookPost200ResponseFromJSONTyped(json, false);
}
export function ApiV2MarketOrderBookPost200ResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ApiV2MarketOrderBookPost200ResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfApiV2MarketOrderBookPost200ResponseOneOf(value)) {
        return ApiV2MarketOrderBookPost200ResponseOneOfToJSON(value);
    }
