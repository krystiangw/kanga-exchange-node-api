 ...
 */
export function instanceOfApiV2PayPaymentGetPost200ResponseOneOf4(value) {
    let isInstance = true;
    isInstance = isInstance && "result" in value;
    isInstance = isInstance && "code" in value;
    return isInstance;
}
export function ApiV2PayPaymentGetPost200ResponseOneOf4FromJSON(json) {
    return ApiV2PayPaymentGetPost200ResponseOneOf4FromJSONTyped(json, false);
}
export function ApiV2PayPaymentGetPost200ResponseOneOf4FromJSONTyped(json, ignoreDiscriminator) {
...
export function ApiV2PayPaymentGetPost200ResponseOneOf4ToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
