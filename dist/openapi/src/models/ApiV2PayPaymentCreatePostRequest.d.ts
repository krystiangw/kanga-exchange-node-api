 ...
 */
export declare function instanceOfApiV2PayPaymentCreatePostRequest(value: object): boolean;
export declare function ApiV2PayPaymentCreatePostRequestFromJSON(json: any): ApiV2PayPaymentCreatePostRequest;
export declare function ApiV2PayPaymentCreatePostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV2PayPaymentCreatePostRequest;
export declare function ApiV2PayPaymentCreatePostRequestToJSON(value?: ApiV2PayPaymentCreatePostRequest | null): any;
//# sourceMappingURL=ApiV2PayPaymentCreatePostRequest.d.ts.map