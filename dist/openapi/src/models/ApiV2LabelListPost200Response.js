 ...
 */
import { instanceOfApiV2LabelListPost200ResponseOneOf, ApiV2LabelListPost200ResponseOneOfFromJSONTyped, ApiV2LabelListPost200ResponseOneOfToJSON, } from './ApiV2LabelListPost200ResponseOneOf';
...
export function ApiV2LabelListPost200ResponseFromJSON(json) {
    return ApiV2LabelListPost200ResponseFromJSONTyped(json, false);
}
export function ApiV2LabelListPost200ResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ApiV2LabelListPost200ResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    if (instanceOfApiV2LabelListPost200ResponseOneOf(value)) {
        return ApiV2LabelListPost200ResponseOneOfToJSON(value);
    }
