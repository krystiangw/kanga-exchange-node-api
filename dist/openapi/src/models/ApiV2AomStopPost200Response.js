...
export function ApiV2AomStopPost200ResponseFromJSON(json) {
    return ApiV2AomStopPost200ResponseFromJSONTyped(json, false);
}
export function ApiV2AomStopPost200ResponseFromJSONTyped(json, ignoreDiscriminator) {
...
export function ApiV2AomStopPost200ResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
